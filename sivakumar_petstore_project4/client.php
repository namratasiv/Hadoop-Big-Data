...
$query2 = "INSERT INTO users ( email, password, roleid) VALUES ('$email', '1234567', '2')";     
...
try {
    ...
    $mail->Subject='New Client Registration - Pet Store';
    $mail->Body='<p>Hello, Thank you for registering as a client with us!</p><br>You can login with your email address: '.$email.' and password 1234567';
