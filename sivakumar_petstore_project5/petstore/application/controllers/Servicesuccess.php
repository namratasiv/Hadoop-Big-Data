...
class Servicesuccess extends CI_Controller {
...
$this->service->form_insert($data);

//Loading View
$this->load->view('servicesuc', $data);
...
$data1 = array(
    ...
    //Transfering data to Model
    $this->service->form_insertt($data1);
}
$this->load->library('email'); // Note: no $config param needed
$this->email->from('nam.sivvv@gmail.com');
$this->email->to($e);
$this->email->subject('Pet Store Inc. Registration Successful');
$this->email->message('You have registered as a business successfully! You can login with password 1234567');
$this->email->send();
